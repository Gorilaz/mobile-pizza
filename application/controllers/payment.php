...
class Payment extends WMDS_Controller{
    ...
    function __construct(){
        ...
        $config = array(
            ...
            'EndPointURL'    => $siteSetting->CC_paypal_address     // API version you'd like to use for your call.  You can set a default version in the class and leave this blank if you want.
        );

        */
        $config = array(
            'Sandbox'       => $this->config->item('Sandbox'),          // Sandbox / testing mode option.
            'APIUsername'   => $siteSetting->CC_paypal_user,      // PayPal API username of the API caller
            'APIPassword'   => $siteSetting->CC_paypal_pass,
            'APISignature'  => $siteSetting->CC_paypal_secret,
            'APISubject'    => '',                                      // PayPal API subject (email address of 3rd party user that has granted API permission for your app)
            'APIVersion'    => $this->config->item('APIVersion'),        // API version you'd like to use for your call. You can set a default version in the class and leave this blank if you want.
            'EndPointURL'   => $siteSetting->CC_paypal_address
        );

        //$endpoint1= $this->config->item('CC_paypal_address');
        //echo "endpoint is endpoint1"; die;
       // Show Errors
        if($config['Sandbox'])
        {
...
//      print_r($this->input->post());die;
        ...
        //$dump=$this->session->userdata('logged');
        //error_log( print_R($dump,TRUE) ); //die;
...
//            'issuenumber'       => $credit['issue_number']                            // Issue number of Maestro or Solo card.  Two numeric digits max.
        ...
        $suburbData   = $this->address->getSuburbDataById($user['suburb']);
        ...
        //error_log("XXXXX");
        //error_log( print_R($BillingAddress,TRUE) ); die;
