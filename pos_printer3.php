...
//$data .= "$TXT_ALIGN_CT";
$data = "\x1b\x21\x10\x1b\x21\x20\x1b\x2d\x02\x1b\x45\x01\x1b\x61\x01ORDER_NO_123 - REMOTE_wifi_router_direct\x0a \x1b\x21\x00 \x1b\x61\x00";
$data = "\x01\x1b\x61\x01MMIDDLE\x0a \x1b\x61\x00";
...
$fp=fsockopen("115.70.72.250", 87, $errno, $errstr, 10);
if (!$fp){
  die('no connection');
}
echo"connection OK";
